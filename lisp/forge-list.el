...
(defcustom forge-owned-accounts nil
  "A list of Github accounts that are owned by you.
This should include your username as well as any organisation
that you own.  Used by the commands `forge-list-owned-issues'
and `forge-list-owned-pullreqs'.  To tell these commands to
ignore certain repositories use `forge-owned-blacklist'."
  :package-version '(forge . "0.2.0")
  :group 'forge
  :type '(repeat (string :tag "Account")))

(defcustom forge-owned-blacklist nil
  "A list of blacklisted Github repositories.
This is a list of package names.  Only used by the commands
...
Option `forge-owned-accounts' controls which repositories are
considered to be owned by you.  Only Github is supported for
now."
  (interactive)
